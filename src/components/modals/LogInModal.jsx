...
function LogInModal({ setLogInModal, setRegisterModal }) {
  ...
  return (
    ...
    >
        ...
        <section className="h-auto bg-slate-500 rounded-xl ">
          <div
          ...
          >
            <div className="h-full items-center justify-center lg:justify-between w-80">
              
                  <div className="grid grid-cols-5 items-center justify-center lg:justify-start">
                    <p className="col-span-2 mb-0 me-4 text-lg text-white font-bold">
                      Sign in with
                    </p>
                  ...
                  <div className="text-center lg:text-left items-center justify-center flex flex-wrap">
